...
export default function ContactFormSection() {
  ...
  return (
    <section className="bg-white text-[#171717] font-sans px-6 py-20 sm:px-12 md:px-16 lg:px-24">
      <div className="max-w-[1440px] mx-auto">
        <div className="mb-20">
          ...
          >
            Have a project in mind or just want to say hi? Reach out using the form below, and I&apos;ll
            get back to you faster than you can say &ldquo;Operations.&rdquo;
          </motion.p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex-1 space-y-12">
            ...
            >
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Ann.a.anidumaka@gmail.com *"
                className="w-full bg-transparent border-b border-zinc-200 py-4 text-2xl sm:text-3xl font-heading font-medium placeholder:text-zinc-200 focus:outline-none focus:border-[#4A1942] transition-all"
                required
              />
            </motion.div>
